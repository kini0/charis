            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="mt-3 fs-15 fw-medium">@include('layouts.status')</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Geodrone. Réalisé avec <i class="mdi mdi-heart text-danger"></i> par KIN'S
                            </p>
                        </div>
                    </div>
                </div>
